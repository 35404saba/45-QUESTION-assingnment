...
let guests: string[] = ["tahira", "nida", "misbah", "samra"];
...
let unavailableGuest: string = "nida";
console.log(
  `\nUnfortunately, ${unavailableGuest} can't make it to the dinner.`
);

//  Replace the guest who can't make it with a new guest
let guestIndex: number = guests.indexOf(unavailableGuest);
if (guestIndex !== -1) {
  let newGuest: string = "yasmeen";
