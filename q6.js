...
const NameWithWhitespace = "\t saba/n";
console.log("NameWithWhitespace:", NameWithWhitespace);
const name_stripped = NameWithWhitespace.trim(); //strip the whitespace fron the name
console.log("name after stripped whitespace:", name_stripped);
export {};
